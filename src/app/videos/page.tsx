...
export default function VideosPage() {
	return (
		<>
			<head>
				<title>Video hướng dẫn điện mặt trời | AI Solar Designer</title>
				<meta
					name="description"
					content="Thư viện video hướng dẫn, chia sẻ kinh nghiệm lắp đặt, sử dụng và tối ưu hệ thống điện mặt trời."
				/>
			</head>
			<div className="space-y-8">
				<h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl font-headline">
					Video hướng dẫn điện mặt trời
				</h1>
