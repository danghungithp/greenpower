...
export default function BuilderPage() {
  ...
  return (
    <>
      <head>
        <title>Thiết kế hệ thống điện mặt trời | AI Solar Designer</title>
        <meta name="description" content="Tự động thiết kế hệ thống điện mặt trời chi tiết: sơ đồ, bảng vật tư, thông số kỹ thuật và báo giá. Công cụ AI miễn phí." />
      </head>
      <div className="space-y-8">
        <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl font-headline">
          Thiết kế hệ thống điện mặt trời chi tiết
        </h1>
